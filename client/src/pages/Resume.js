...
import GDLogo from "../images/gd_logo2.webp";
...
<div className='experience'>
  ...
  <p><strong>Front End Software Engineer</strong>, <span className='nobr'>San Francisco, CA, May 2021 – Current</span>
<br></br>
<strong></strong></p>
<p>
Enterprise scale, front-end and full-stack web development.  As part of a large team of developers, working on the redesign of the SVB-GO App for Silicon Valley Bank, I work with React, Typescript, Jest, Mob-X, Sass, and NodeJS, to devleop the UI and API.  My focus is on engineering front-end features on two-week sprints as part of an agile team process.  We use Jenkins, Bitbucket, and OpenShift for deployment, and Elastic Search and AppDynamics for data queries and analysis.
</p>
<p><a href='https://www.griddynamics.com/'>https://www.griddynamics.com/</a></p>
...
<div className='experience'>
  ...
  <p><strong>Self Employed Full Stack Developer</strong>, <span className='nobr'>San Francisco, CA, 2009 – May 2021</span>
<br></br>
<strong></strong></p>
<p>
...
<p>  <a href='https://ddworks.org'>https://ddworks.org</a></p>
  </div>
</div>
...
<ul>
<li>
<b>BFA</b> - Bachelor of Fine Arts in Computer Graphics & Design<br></br>Pratt Institute, School of Art and Design, Brooklyn NY</li>
<li>
